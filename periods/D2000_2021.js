module.exports = [
    {
        ...
        medium: `Physically published academic research article, digitized`,
    ...
    },
    {
        ...
        medium: `Digitally published academic research article`,
    ...
    {
        container: `<i>Proceedings of the National Academy of Sciences of the United States of America</i> (<i>Proc</i>. <i>Natl</i>. <i>Acad</i>. <i>Sci</i>. <i>U</i>.<i>S</i>.<i>A</i>., <i>PNAS</i>), digitally published academic journal`,
        contributors: `Eleftheria Palkopoulou (research designer, data analyst, coauthor); Mark Lipson (data analyst, coauthor); Swapan Mallick (data analyst); Svend Nielsen (data analyst); Nadin Rohland (laboratory analyst); Sina Baleka (laboratory analyst); Emil Karpinski (laboratory analyst); Atma M. Ivancevic (data analyst); Thu-Hien To (data analyst); R. Daniel Kortschak (data analyst); Joy M. Raison (data analyst); Zhipeng Qu (data analyst); Tat-Jun Chin (data analyst); Kurt W. Alt (sample assembler); Stefan Claesson (sample assembler); Love Dalén (sample assembler); Ross D.E. MacPhee (sample assembler, coauthor); Harald Meller (sample assembler); Alfred L. Roca (sample assembler, coauthor); Oliver A. Ryder (sample assembler); David Heiman (data analyst); Sarah Young (data analyst); Matthew Breen (data analyst); Christina Williams (data anaylst); Bronwen L. Aken (data analyst); Magali Ruffier (data analyst); Elinor Karlsson (coauthor); Jeremy Johnson (data analyst); Federica Di Palma (data analyst); Jessica Alfoldi (data analyst);  David L. Adelson (data analyst); Thomas Mailund (data analyst); Kasper Munch (data analyst); Kerstin Lindblad-Toh (research designer, data analyst); Michael Hofreiter (research designer, sample assembler, coauthor); Hendrik Poinar (research designer, sample assembler, coauthor); David Reich (research designer, sample assembler, coauthor)`,
    ...
    {
        container: `<i>Pokémon Trading Card Game (TCG): Sword and Shield — Darkness Ablaze</i>, physically published card game expansion`,
        ...
        location: `N/A`,
        medium: `Physically published playing card, digitized`,
    ...
    },
    {
        ...
        medium: `Digitally published article and radio segment`,
    ...
    {
        container: `<i>The IUCN Red List of Threatened Species</i>, published website`,
        contributors: `K.S. Gobush (assessor); C.T. Edwards (assessor); D. Balfour (assessor); George Wittemyer (assessor); Fiona Maisels (assessor); R.D. Taylor (assessor); J. Selier (reviewer); N. Sabanda (reviewer); J. Blanc (contributor); J.P. Ross (facilitator, compiler)`,
        date: `25 March 2021`,
        duration: `N/A`,
        languages: `English`,
    ...
    {
        container: `<i>The IUCN Red List of Threatened Species</i>, published website`,
        contributors: `K.S. Gobush (assessor); C.T. Edwards (assessor); Fiona Maisels (assessor); George Wittemyer (assessor); D. Balfour (assessor); R.D. Taylor (assessor); J. Selier (reviewer); N. Sabanda (reviewer); J. Blanc (contributor); J.P. Ross (facilitator, compiler)`,
        date: `25 March 2021`,
        duration: `N/A`,
        languages: `English`,
