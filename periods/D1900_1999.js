module.exports = [
    {
        container: `<i>Sitzungsberichte der Gesellschaft Naturforschender Freunde zu Berlin</i> (<i>Sitzber</i>. <i>Ges</i>. <i>Naturforsch</i>. <i>Berl</i>.), physically published scholarly journal`,
    ...
    {
        container: `<i>Proceedings of the General Meetings for Scientific Business of the Zoological Society of London</i> (<i>Proc</i>. <i>Zool</i>. <i>Soc</i>. <i>Lond</i>.), physically published scholarly journal`,
    ...
    {
        container: `<i>American Museum Novitates</i> (<i>Am</i>. <i>Mus</i>. <i>Novit</i>.), physically published scholarly journal`,
    ...
    {
        container: `<i>Proceedings of the Academy of Natural Sciences of Philadelphia</i> (<i>Proc</i>. <i>Acad</i>. <i>Nat</i>. <i>Sci</i>. <i>Phila</i>.), physically published scholarly journal`,
    ...
    {
        container: `<i>Bulletin of the Raffles Museum</i> (<i>Bull</i>. <i>Raffle</i> <i>Mus</i>.), physically published scholarly journal`,
    ...
    {
        container: `<i>Földtani Közlöny</i> (<i>Földt</i>. <i>Közlöny</i>), physically published scholarly journal`,
    ...
    {
        container: `<i>Journal of Geography</i> (<i>J</i>. <i>Geogr</i>.), physically published scholarly journal`,
    ...
    {
        container: `<i>East African Wildlife Journal</i> (<i>East</i> <i>Afr</i>. <i>Wildl</i>. <i>J</i>.), physically published scholarly journal`,
    ...
    {
        container: `<i>Nature</i> (<i>Nat</i>.), physically published scholarly journal`,
    ...
    {
        container: `<i>Mammalian Species</i> (<i>Mamm</i>. <i>Species</i>), physically published scholarly journal`,
    ...
    },
    {
        ...
        medium: `Physically published news article, digitized`,
    ...
    {
        container: `<i>Bulletin of the Psychonomic Society</i> (<i>Bull</i>. <i>Psychon</i>. <i>Soc</i>.), physically published scholarly journal`,
    ...
    {
        container: `<i>African Journal of Ecology</i> (<i>Afr</i>. <i>J</i>. <i>Ecol</i>.), physically published scholarly journal`,
    ...
    {
        container: `<i>Animal Behavior</i> (<i>Anim</i>. <i>Behav</i>.), physically published scholarly journal`,
    ...
    {
        container: `<i>Journal of Zoology London</i> (<i>J</i>. <i>Zool</i>. <i>Lond</i>.), physically published scholarly journal`,
    ...
    {
        container: `<i>Acta Theriologica</i> (<i>Acta</i> <i>Theriol</i>.), physically published scholarly journal`,
    ...
    {
        container: `<i>Biological Conservation</i> (<i>Biol</i>. <i>Conserv</i>.), physically published scholarly journal`,
    ...
    {
        container: `<i>Zeitschrift für Säugetierkunde</i> (<i>Z</i>. <i>Saugetierkd</i>.), physically published scholarly journal`,
    ...
    {
        container: `<i>Emerging Infectious Diseases</i> (<i>Emerg</i>. <i>Infect</i>. <i>Dis</i>.), digitally published scholarly journal`,
    ...
    {
        container: `<i>Trends in Ecology and Evolution</i> (<i>Trends</i> <i>Ecol</i>. <i>Evol</i>., <i>TREE</i>), digitally published scholarly journal`,
