module.exports = [
    {
        container: `<i>Sitzungsberichte der Gesellschaft Naturforschender Freunde zu Berlin</i> (<i>Sitzber</i>. <i>Ges</i>. <i>Naturforsch</i>. <i>Berl</i>.)`,
    ...
    {
        container: `<i>Proceedings of the General Meetings for Scientific Business of the Zoological Society of London</i> (<i>Proc</i>. <i>Zool</i>. <i>Soc</i>. <i>Lond</i>.)`,
    ...
    {
        container: `<i>American Museum Novitates</i> (<i>Am</i>. <i>Mus</i>. <i>Novit</i>.)`,
    ...
    {
        container: `<i>Proceedings of the Academy of Natural Sciences of Philadelphia</i> (<i>Proc</i>. <i>Acad</i>. <i>Nat</i>. <i>Sci</i>. <i>Phila</i>.)`,
    ...
    {
        container: `<i>Bulletin of the Raffles Museum</i> (<i>Bull</i>. <i>Raffle</i> <i>Mus</i>.)`,
    ...
    {
        container: `<i>Földtani Közlöny</i> (<i>Földt</i>. <i>Közlöny</i>)`,
    ...
    {
        container: `<i>Journal of Geography</i> (<i>J</i>. <i>Geogr</i>.)`,
    ...
    {
        container: `<i>East African Wildlife Journal</i> (<i>East</i> <i>Afr</i>. <i>Wildl</i>. <i>J</i>.)`,
    ...
    {
        container: `<i>Mammalian Species</i> (<i>Mamm</i>. <i>Species</i>)`,
    ...
    {
        container: `<i>Bulletin of the Psychonomic Society</i> (<i>Bull</i>. <i>Psychon</i>. <i>Soc</i>.)`,
    ...
    {
        container: `<i>African Journal of Ecology</i> (<i>Afr</i>. <i>J</i>. <i>Ecol</i>.)`,
    ...
    {
        container: `<i>Animal Behavior</i> (<i>Anim</i>. <i>Behav</i>.)`,
    ...
    {
        container: `<i>Journal of Zoology London</i> (<i>J</i>. <i>Zool</i>. <i>Lond</i>.)`,
    ...
    {
        container: `<i>Acta Theriologica</i> (<i>Acta</i> <i>Theriol</i>.)`,
    ...
    {
        container: `<i>Biological Conservation</i> (<i>Biol</i>. <i>Conserv</i>.)`,
    ...
    },
    {
        ...
        container: '<i>AWF Technical Handbook Series</i>, print book series',
        date: `1996`,
        duration: `178 pp.`,
        iteration: `No. 7`,
    ...
    {
        container: `<i>Zeitschrift für Säugetierkunde</i> (<i>Z</i>. <i>Saugetierkd</i>.)`,
    ...
    {
        container: `<i>Emerging Infectious Diseases</i> (<i>Emerg</i>. <i>Infect</i>. <i>Dis</i>.), Electronic journal`,
        ...
        location: `N/A`,
        medium: `Electronic research article`,
    ...
    {
        container: `<i>Proceedings of the National Academy of Sciences of the United States of America</i> (<i>Proc</i>. <i>Natl</i>. <i>Acad</i>. <i>Sci</i>. <i>U</i>.<i>S</i>.<i>A</i>., <i>PNAS</i>), Electronic journal`,
    ...
    {
        container: `<i>Trends in Ecology and Evolution</i> (<i>Trends</i> <i>Ecol</i>. <i>Evol</i>., <i>TREE</i>), Electronic journal`,
